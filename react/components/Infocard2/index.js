...
const MemoizedInfoCard2 = memo(injectIntl(InfoCard))

MemoizedInfoCard2.propTypes = {
  blockClass: string,
...
MemoizedInfoCard2.defaultProps = {
...
export default MemoizedInfoCard2
